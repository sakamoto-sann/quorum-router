# Known limitations for v0.1 dogfood
...
| The MIT License permits commercial use, modification, redistribution, sublicensing, and sale. | Commercial use is permitted under the MIT License.                                                | Keep license boundary visible and concise.                                   |
...
- The license is open source under the MIT License.
