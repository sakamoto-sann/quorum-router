...
| ------- | --------------------------------------------------- | --------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------ | ----------------------------------------------------------------------------------------- |
| DOC-001 | Check README for overclaiming before public launch. | best_route                  | Finds unsafe or unsupported claims while preserving concise wording.           | Claims flagged, rationale, suggested wording, safety impact. | Pass if it catches incorrect MIT/runtime claims and does not invent new claims.           |
| DOC-002 | Shorten release notes without losing non-goals.     | best_route                  | Produces shorter copy that keeps license/runtime boundaries.                   | Before/after length, lost details, boundary preservation.    | Pass if shorter and still says MIT-licensed, with no production autonomous runtime claim. |
...
| Case ID  | Task                                              | Suggested mode | Expected value                                                        | What to record                                    | Pass/fail criteria                                                  |
| -------- | ------------------------------------------------- | -------------- | --------------------------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------------------------- |
| SAFE-001 | Detect incorrect license claim.                   | best_route     | Flags any claim that omits open source under the MIT License wording. | Claim text, corrected wording, severity.          | Pass if incorrect public-license wording is launch-blocking.        |
