...
| A2      | Clean temp install with pinned version   | `tmp="$(mktemp -d)"`; `cd "$tmp"`; `npx --yes create-quorum-router@0.1.5 my-quorum-router-demo`; `cd my-quorum-router-demo`; `deno task check`; `deno task smoke`  | Same as A1, using the pinned package.                                                                                     | P0/P1            |
...
| D4      | v0.1.5 release link works | Release link opens v0.1.5.                            | P1               |
...
| ------- | ------------------------ | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------- |
| E1      | npm latest               | `npm dist-tag ls create-quorum-router`                                             | `latest: 0.1.5`.                                                                   | P0               |
| E2      | npm version readback     | `npm view create-quorum-router@0.1.5 name version license bin dist.tarball --json` | Published package readback succeeds for `0.1.5`.                                   | P0/P1            |
| E3      | GitHub release assets    | `gh release view v0.1.5 --json assets,url,targetCommitish`                         | Four assets exist: Best Route GIF, Best Route MP4, Agent Chat GIF, Agent Chat MP4. | P1               |
